...
<body>
    <header>
        <div class="header-content">
            ...
            <img src="/storage/emulated/0/College matiriyal /IMG-20250119-WA0023.jpg" alt="Your Profile Picture" class="profile-picture">
            <h1>Pooja S</h1>
    ...
    <section id="resume">
        ...
        <div class="section-content">
            <center>
            <h2>Resume</h2>
            <a href="/storage/emulated/0/Download/pooja resume.pdf" target="_blank" class="download-button">Download CV</a>
        </center>
        </div>
